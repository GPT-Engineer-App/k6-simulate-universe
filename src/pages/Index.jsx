  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-purple-100 p-8">
      <div className="max-w-4xl mx-auto">
          ...
          <Card>
            ...
            <CardContent>
              <ul className="list-disc pl-5">
                ...
                <li>Tail positioning: Can indicate mood</li>
                <li>Meowing: Communication with humans</li>
                <li>Scratching: Natural behavior for claw maintenance</li>
              </ul>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">Cat Care Tips</h2>
          <div className="flex flex-wrap gap-2">
            <Badge variant="secondary">Regular vet check-ups</Badge>
            <Badge variant="secondary">Balanced diet</Badge>
            <Badge variant="secondary">Fresh water daily</Badge>
            <Badge variant="secondary">Litter box cleaning</Badge>
            <Badge variant="secondary">Playtime and exercise</Badge>
            <Badge variant="secondary">Grooming</Badge>
          </div>
        </div>
